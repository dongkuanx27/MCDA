...
def RNN(X1, X2, weights, biases, n_steps, n_hidden_units, batch_size, n_dim, num_stacked_layers, in_keep_prob, out_keep_prob):
    ...
    if num_stacked_layers > 1:
        ...
        feature1 = final_state_1[1]
        feature2 = final_state_2[1]
...
if __name__ == '__main__':
    ...
    z1, z2 = RNN(x1, x2, weights, biases, n_steps, n_hidden_units, batch_size, n_dim, num_stacked_layers, in_keep_prob, out_keep_prob)
        ...
        while epoch < training_iters:
           ...
           # batch_data_pool.reshuffle()
            while step < stepNum:
                ...
                sess.run([train_op], feed_dict={x1: bt1, x2: bt2, y: y_label})
                loss = cost.eval(feed_dict={x1: bt1, x2: bt2, y: y_label})
                training_loss += loss
                step += 1
